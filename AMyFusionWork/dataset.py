...
class TestData(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img1_name = self.dir_prefix + 'over/' + self.over_dir[idx]
        img2_name = self.dir_prefix + 'under/' + self.under_dir[idx]

        name_img1 = img1_name.split('/')[-1]
        # name_img2 = img2_name.split('/')[-1]

        over = cv2.imread(img1_name)
        under = cv2.imread(img2_name)
        ...
        return idx, name_img1, img2_name, img_stack
